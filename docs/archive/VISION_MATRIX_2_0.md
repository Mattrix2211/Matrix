> **Document historique, archivé le 23/09/2026.** Condensé du cahier des charges Matrix 2.0, rédigé par l'agent le 06/09/2026 à partir de la page Notion « Cahier des charges », puis resté sur le poste local sans être commité (il a été retrouvé et versé ici le 23/09/2026). **La source à jour est la page Notion « Cahier des charges »**, pas ce fichier.
>
> Il est conservé parce que d'anciennes tâches Notion et d'anciens commentaires de code citent « VISION §N ». Sa numérotation diffère de celle de la page Notion. Correspondances principales :
>
> | Ce fichier (VISION) | Page Notion « Cahier des charges » |
> |---|---|
> | §7.1 Gestion des quarts | §8 |
> | §7.2 Service à quai / gardes | §9 |
> | §7.3 Génération intelligente | §10 et §11 |
> | §7.4 Échange de service | §12 à §14 |
> | §8 Communication | §16 à §19 |
> | §13 Architecture réseau | §25 à §28 |
> | §14 Sécurité, historisation, versioning | §29 à §31 |
> | §16 Configuration > code | §33 |
> | §17 Proposer → valider → publier | §34 |
> | §20 Les 7 principes | §41 |
> | §21 Règle de développement dérivée | propre à ce fichier, reprise dans `CLAUDE.md` (principe n°11) |
> | §22 Roadmap | §42 |
